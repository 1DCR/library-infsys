...
def report_create_index():
    ...
    report_create_result = report_create(current_app.config['db_config'][session.get('user_group', 'guest')], provider,
                                         user_input_data)
...
def report_view_index():
    user_input_data = request.form.to_dict()
    report_get_result = report_get(current_app.config['db_config'][session.get('user_group', 'guest')], provider,
                                   user_input_data)
